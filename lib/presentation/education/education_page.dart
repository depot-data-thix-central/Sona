                  ...
                  children: [
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      onPressed: () async {
                                            ...
                                            return Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  const Text(
                                                    'Inscription à une formation officielle (paiement simulé).',
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: ElevatedButton.icon(
                                                      ...
                                                      label: const Text("Confirmer (45 USD)"),
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(content: Text('Inscription enregistrée. Paiement simulé de 45 USD.'))
                                        );
                                      },
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: LightModeColors.accent,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: AppSpacing.md),
                        const FormationCard(
                          title: "Cadre Légal de l'Identité Numérique (RDC)", 
                        ...
                        const FormationCard(
                          title: "Intégration API THIX pour Entreprises", 

...
class _ReservationVolsPageState extends State<ReservationVolsPage> {
  ...
  Future<void> _rechercherVols() async {
    ...
    final vols = [
      {'id': '1', 'compagnie': 'Ethiopian Airlines', 'codeVol': 'ET 914', 'depart': 'Kinshasa (FIH)', 'arrivee': 'Paris (CDG)', 'heureDepart': '23:45', 'heureArrivee': '06:10', 'duree': '10h 25min', 'escales': 0, 'prix': 780.0, 'devise': 'USD', 'bagageCabine': '7kg', 'bagageSoute': '23kg', 'repasInclus': true},
      {'id': '2', 'compagnie': 'Turkish Airlines', 'codeVol': 'TK 543', 'depart': 'Kinshasa (FIH)', 'arrivee': 'Paris (CDG)', 'heureDepart': '18:30', 'heureArrivee': '09:15', 'duree': '13h 45min', 'escales': 1, 'prix': 650.0, 'devise': 'USD', 'bagageCabine': '8kg', 'bagageSoute': '23kg', 'repasInclus': true},
      {'id': '3', 'compagnie': 'Air France', 'codeVol': 'AF 771', 'depart': 'Kinshasa (FIH)', 'arrivee': 'Paris (CDG)', 'heureDepart': '10:15', 'heureArrivee': '16:50', 'duree': '8h 35min', 'escales': 0, 'prix': 920.0, 'devise': 'USD', 'bagageCabine': '12kg', 'bagageSoute': '23kg', 'repasInclus': true},
    ];
